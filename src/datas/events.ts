...
export const eventsData = [
  {
    id: 1,
    title: "Annual Convecation 2025-  Bangkok",
    date: "December 26, 2024",
    excerpt: "Agro Ventures Plantations (Pvt) Ltd's...",
    brief:
      "Agro Ventures Plantations (Pvt) Ltd's Annual Field Convention took place on April 10, 2025, at the Hotel Grand Mountain in Matale, recognizing the dedication of our team across all estates. Certificates of appreciation were presented to employees, along with school supplies for their children and cash scholarships to support their academic journeys. This initiative reflects our commitment to poverty alleviation, rural development, sustainability, and",
    images: [
      ...
      "https://res.cloudinary.com/avplantations/image/upload/v1773728338/bk9_f6dikd.webp",
