...
const AboutHeaderSection = () => {
  return (
    <section className="avp-hero about-hero">
      <video
      ...
      <div className="avp-hero__body">
        ...
        <h1 className="avp-hero__headline">
          ...
          <span className="avp-hero__hl-outline" aria-hidden="true">
            Plantations
          </span>
        </h1>
      ...
      <div
        className="avp-hero__sidetag"
        aria-label="Established 2005, Sri Lanka"
      >
        <p>Est. 2005</p>
        <p>Sri Lanka</p>
