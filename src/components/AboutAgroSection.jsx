          ...
          <div className="row about-agro-row">
            ...
            <div className="col-md-6 col-sm-12 about-agro-content-col">
              ...
              <div className="about-agro-eyebrow">
                ...
                <span className="about-agro-eyebrow-text">
              ...
              <div className="about-agro-body">
                <p>
                  <strong>Agroventures Plantations (Pvt) Ltd</strong> is a
                  pioneering company dedicated to the cultivation of vanilla and
                  other export-oriented spices. Our vision is to generate{" "}
                ...
                <p>
                  ...
                  standards of international markets - while equally serving Sri
                  Lankan consumers.
                </p>

                {/* Expanded content */}
                <div
                  className={`about-agro-expand-wrap ${isExpanded ? "about-agro-expanded" : ""}`}
                >
                  <p>
                    Our unwavering dedication to sustainability is at the core
                    of our operations. We employ advanced, responsible farming
                ...
                >
                  ...
                  <span
                    className={`about-agro-toggle-icon ${isExpanded ? "about-agro-icon-up" : ""}`}
                  >
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-10 col-md-offset-1 col-sm-12 text-center">
              <span className="about-agro-parallax-eyebrow">
                Our Commitment
              </span>
